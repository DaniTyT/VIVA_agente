...
function LayoutApp() {
  const [userName, setUserName] = React.useState("VIVA BI");
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      ...
      >
        <Toolbar sx={{ flexWrap: "wrap", p: 1, m: 0 }}>
          <Typography
            ...
            color="primary"
            noWrap
            sx={{ flexGrow: 1, p: 0, m: 0, color: "#04843b" }}
          >
            {APP_NAME}
          </Typography>
      ...
      <Box textAlign={"center"}>
        ...
        >
          &copy;{new Date().getFullYear()}, TyT Contact Center Corporativo. Todos los derechos reservados.
        </Typography>
      </Box>
